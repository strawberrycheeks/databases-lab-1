...
<body>
	...
	<content>	
		<main>
			...
			<tr><td class="c2">Печать таблицы<br />individuals из MySQL<br /></td></tr>
			</table>
...
// блок инициализации
try {
	$pdoSet = new PDO('mysql:dbname=bankDB;host=localhost', 'root', '');
	...
	$sqlTM="SELECT * FROM individuals ORDER BY id ASC";  // ASC - по возрастанию; DESC - по убыванию.
    echo $sqlTM;
